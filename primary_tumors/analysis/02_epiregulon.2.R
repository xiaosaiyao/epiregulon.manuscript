...
archr.proj <- archr.proj[archr.proj$clusterName %in% c("Tumor", "Oligodendrocytes","Neurons","OPC","Astrocytes"),]
...
# subsample
set.seed(1010)
subsample.idx <- sample(1:ncol(GeneExpressionMatrix), 50000, replace = FALSE)
