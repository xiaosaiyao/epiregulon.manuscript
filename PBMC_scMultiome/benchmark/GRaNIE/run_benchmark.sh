...
specification="1,64,/gstore/project/epigen/benchmark/PBMC/GRaNIE,PBMC,GRaNIE,preprocessing,Rosalind,$(date +%Y-%m-%d_%H:%M)"
...
file_path="/gstore/project/epigen/benchmark/PBMC/GRaNIE/slurm-${job_id}.out"
...
specification="20,128,/gstore/project/epigen/benchmark/PBMC/GRaNIE,PBMC,GRaNIE,main,Rosalind,$(date +%Y-%m-%d_%H:%M)"
