...
specification="1,64,/gstore/project/epigen/benchmark/PBMC/Epiregulon,PBMC,Epiregulon,preprocessing,Rosalind,$(date +%Y-%m-%d_%H:%M)"
...
file_path="/gstore/project/epigen/benchmark/PBMC/Epiregulon/slurm-${job_id}.out"
...
export job_id=$job_id
file_path="/gstore/project/epigen/benchmark/PBMC/Epiregulon/slurm-${job_id}.out"
specification="20,64,/gstore/project/epigen/benchmark/PBMC/Epiregulon,PBMC,Epiregulon,main,Rosalind,$(date +%Y-%m-%d_%H:%M)"
echo "${job_id},${specification}" >> /gstore/project/epigen/benchmark/resource_use.txt
sbatch --dependency=afterok:$job_id --export=ALL /gstore/project/epigen/benchmark/PBMC/save_stats.sh
