...
saveRDS(regulon.w, "/gstore/project/epigen/benchmark/PBMC/OUTPUT/regulon.w_blood_trimmed_no_clusters.rds")
...
regulon.w2 <- addWeights(pruned.regulon, expMatrix = GeneExpressionMatrix,
                         ...
                         method = "MI")
saveRDS(regulon.w2, "/gstore/project/epigen/benchmark/PBMC/OUTPUT/regulon.w_MI_trimmed_blood_no_clusters.rds")

regulon.w3 <- addWeights(pruned.regulon, expMatrix = GeneExpressionMatrix,
                         peakMatrix = peakMatrix, exp_assay="normalizedCounts",
                         peak_assay="counts", clusters = GeneExpressionMatrix$cell_type,
                         method = "corr")
saveRDS(regulon.w3, "/gstore/project/epigen/benchmark/PBMC/OUTPUT/regulon.w_corr_blood_trimmed_no_clusters.rds")
